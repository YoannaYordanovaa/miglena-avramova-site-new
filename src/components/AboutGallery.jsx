    ...
    <AnimatePresence>
      {selectedImage && (
        ...
        >
          ...
          >
            <ChevronLeft size={window.innerWidth < 768 ? 40 : 64} strokeWidth={1} />
          </button>
          ...
          >
            <ChevronRight size={window.innerWidth < 768 ? 40 : 64} strokeWidth={1} />
          </button>
          ...
          {/* КОРИГИРАН КОНТЕЙНЕР ЗА ПРЕМАХВАНЕ НА ГЛИЧА */}
          <div className="relative flex flex-col items-center justify-center w-full h-full max-w-5xl pointer-events-none">
            <AnimatePresence mode="wait"> {/* mode="wait" оправя застъпването на снимките */}
              <motion.div
