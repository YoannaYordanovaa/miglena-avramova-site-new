...
<section className="relative py-20 md:py-32 pt-38 px-6  overflow-hidden text-left">
  <div className="max-w-7xl mx-auto px-6 relative z-10">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-center">
      ...
      >
        ...
        <h1 className="text-brand-dark tracking-tight font-display text-5xl md:text-7xl leading-[1.1]">
          ...
          <span className="text-brand-primary italic font-light relative inline-block">
            ...
            <motion.svg
              ...
              viewBox="0 0 300 12"
            >
              <path d="M1 10C50 3 150 3 299 10" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round" />
            </motion.svg>
          </span>
          <br /> започва тук!
        </h1>
        ...
        <div className="flex flex-col gap-8 items-start pt-4">
          <p className="font-sans font-light text-xl text-gray-500 max-w-xl leading-relaxed border-l-2 border-brand-primary/20 pl-6">
            ...
            живот, да помагат на другите и да изградят кариера в сферата на
            уелнес индустрията.
          </p>
          ...
          <div className="flex flex-wrap gap-4 justify-start items-center">
            ...
            <a href="#video" className="btn-outline flex items-center gap-2 group">
              Научи повече
              <ArrowRight
                size={18}
                strokeWidth={1.2}
      ...
      >
        <motion.div whileHover={{ scale: 1.02 }} className="relative group z-10 w-full max-w-[600px]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((b, i) => (
              ...
              >
                ...
                <h3 className="font-sans font-medium text-brand-dark case text-[12px] tracking-[0.2em] mb-4">
                  {b.title}
                </h3>
           ...
           <div className="flex flex-wrap gap-4 justify-center items-center mt-16">
            <a href="#join-form" className="btn-primary flex items-center gap-2 group">
     ...
     <section className="relative py-20 md:py-32 px-4 md:px-6 bg-white overflow-hidden">
        ...
        <div className="grid lg:grid-cols-12 gap-12 md:gap-16 items-start mb-24 ">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6 relative">
            <div className="space-y-6">
              ...
              >
                <h4 className="font-display text-6xl md:text-7xl font-medium mb-3 italic tracking-tighter text-white">45+</h4>
                <div className="space-y-1">
                  <p className="font-sans text-[12px] uppercase tracking-[0.2em] font-bold opacity-90">Години Лидерство</p>
                  <p className="font-sans text-sm opacity-75 font-light leading-relaxed">Стабилност от 1978 г. без промяна в мисията.</p>
                </div>
              </motion.div>
              ...
              >
                <h4 className="font-display text-6xl md:text-7xl font-medium mb-3 italic tracking-tighter text-white">160+</h4>
                <div className="space-y-1">
                  <p className="font-sans text-[12px] uppercase tracking-[0.2em] font-bold opacity-90">Държави</p>
                  <p className="font-sans text-sm opacity-75 font-light leading-relaxed">Глобално присъствие и логистична мрежа.</p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="md:pt-20 space-y-6">
              <div className="bg-white rounded-[2.5rem] shadow-sm flex flex-col items-start justify-center p-8 md:p-10 border border-brand-light min-h-[260px] md:min-h-[280px] relative overflow-hidden group">
                ...
                <Briefcase className="text-brand-primary mb-6" size={32} strokeWidth={1.5} />
                <p className="font-display text-brand-dark text-3xl tracking-tighter leading-tight">
                  Бизнес без <br /><span className="text-brand-primary italic font-light">граници</span>
                </p>
          ...
          <div className="lg:col-span-5 space-y-10 py-4">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="font-sans text-[10px] uppercase tracking-[0.3em] font-bold text-brand-primary italic">Глобалният Гигант</span>
              </div>
              <h2 className="font-display text-4xl md:text-5xl font-medium text-brand-dark tracking-tighter leading-tight">
                Стабилност, която <br />
                <span className="text-brand-primary italic font-light font-display">променя животи</span>
              </h2>
            </div>

            <div className="space-y-8 font-sans text-gray-500 text-lg leading-relaxed font-light">
              <p>
                <a href="https://foreverliving.com/bgr/bg-bg/about" target="_blank" rel="noopener noreferrer" 
                   className="text-brand-primary font-bold hover:text-brand-dark underline transition-colors">
                 Форевър Ливинг
                </a>  е най-големият производител и дистрибутор на продукти от Алое
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24 w-full relative z-10">
              {[
                { title: "Пълна Прозрачност", desc: "Собствени плантации, заводи и логистика – без външни доставчици.", icon: <BookOpenCheck size={20} /> },
                ...
                <div key={idx} className="flex items-center gap-4 p-4  rounded-2xl border border-brand-light/50 shadow-sm transition-all hover:border-brand-primary/20">
                  ...
                  <div>
                    ...
                    <p className=" text-brand-dark font-light">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <div className="relative flex items-center justify-center py-4 bg-white">
        ...
        <div className="pt-20 md:pt-32 px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { label: "Сигурност", title: "Частна Компания", text: "Forever е финансово независима компания без дългове. Това позволява на борда да взема решения в интерес на партньорите.", icon: <Target size={24} /> },
            { label: "Завещание", title: "Наследяем Бизнес", text: "Изградената от Вас мрежа и доходи могат да бъдат прехвърлени на Вашите наследници – сигурност за Вашето семейство.", icon: <Award size={24} /> },
            { label: "Екология", title: "Еко Отпечатък", text: "Плантациите на Forever пречистват земната атмосфера от над 2 милиона тона CO2 ежегодно. Помагате активно на планетата.", icon: <Sprout size={24} /> },
          ].map((item, idx) => (
            <motion.div
              key={idx}
              whileHover={{ y: -8 }}
            ...
            >
              <span className="font-sans text-[11px] uppercase tracking-[0.3em] text-brand-primary font-bold mb-6 opacity-60 italic">{item.label}</span>
              <div className="w-12 h-12 rounded-2xl bg-brand-primary text-white flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                {React.cloneElement(item.icon, { className: "text-white" })}
              </div>
              <h4 className="font-display text-2xl text-brand-dark font-medium mb-4">{item.title}</h4>
              <p className="font-sans text-gray-500 leading-relaxed font-light opacity-80">{item.text}</p>
              <div className="mt-auto pt-8">
                <div className="w-8 h-[1px] bg-brand-primary/20 group-hover:w-full transition-all duration-700" />
              </div>
            </motion.div>
          ))}
        </div>
      ...
      <section id="join-form" className="py-20 md:py-32 px-6 /50 ">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row bg-white rounded-[3.5rem] soft-shadow border border-brand-light/50 overflow-hidden">
            {/* Dark Panel */}
            <div className="lg:w-[40%] bg-brand-dark p-12 md:p-20 text-white relative text-left">
              <div className="relative z-10 space-y-10">
                <div className="space-y-4">
                  <h2 className="font-display text-white font-medium case tracking-tighter leading-tight">
                    Готов ли си за <br />
                ...
                <p className="font-sans font-light text-white/60 leading-relaxed text-lg">
                  Попълни формата и ще се свържа с теб за безплатна
                  опознавателна среща!
                </p>
                <div className="space-y-6 pt-4 border-t border-white/10">
                  <div className="flex items-center gap-5 group">
                    <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center text-brand-primary group-hover:bg-brand-primary transition-all">
                      <Mail size={20} />
                    </div>
              ...
              <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-brand-primary/10 rounded-full blur-[100px] opacity-50" />
            </div>

            {/* Form Part */}
            <div className="flex-1 p-12 md:p-20 text-left bg-white">
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid md:grid-cols-2 gap-8 text-left">
                  <div className="space-y-3">
                    <label className="font-sans font-regular case  text-brand-dark block">
                      Твоето име
                    </label>
                    <input
                      name="name"
                ...
                <div className="pt-4 text-left">
                  ...
                  {status === "success" && (
                    <p className="mt-4 text-brand-primary font-sans text-sm font-medium">
                      Успешно изпратено!
                    </p>
                  )}
                  {status === "error" && (
                    <p className="mt-4 text-red-500 font-sans text-sm font-medium">
