          ...
          <div className="relative aspect-video md:aspect-[21/9] rounded-[2rem] md:rounded-[4rem] overflow-hidden bg-brand-cream border border-brand-light/20 shadow-[0_32px_64px_-15px_rgba(0,0,0,0.1)]">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              >
                ...
                <div className="w-16 h-16 md:w-24 md:h-24 bg-brand-light text-brand-dark rounded-full flex items-center justify-center shadow-2xl z-10 transition-colors group-hover:bg-brand-primary group-hover:text-white">
                  <Play
