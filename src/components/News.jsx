      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20 text-left space-y-4">
          ...
          <p className="font-sans text-gray-500 text-xl max-w-2xl font-light">
            Бъдете в крак с последните новини от света на уелнеса, екипните ни
            срещи и вдъхновяващи истории.
          </p>
        </div>
          ...
          {news.length > 0 ? (
            news.map((item, idx) => (
              <motion.article
                ...
                className="group bg-brand-light rounded-[3rem] p-10 border border-brand-light/50 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col h-full"
              >
