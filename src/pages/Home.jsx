...
const Home = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: "Ако търсите човек, който ще ви изслуша, ще ви разбере и ще ви подаде ръка без колебание, то това е Меги. Прекрасен човек, който се радвам, че познавам!",
    },
    {
      name: "Невена М.",
      role: "Творец",
      image: "/Testimonials/Petya_pic.webp",
      text: "Работата с Меги ми помогна да подредя нещата малко по малко. Нямаше крайности, нямаше обещания за чудеса – просто ясни стъпки и постоянство.",
    },
  ];
