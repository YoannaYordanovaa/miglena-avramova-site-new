  ...
  const testimonials = [
    {
      ...
      text: "Меги е изключително организиран човек, на когото винаги може да се разчита. Тя работи с отдаденост и сърце, като дава всичко от себе си, за да подкрепя и развива хората в екипа си. Благодарение на постоянството и правилните си стъпки, днес тя е един от най-успешните мениджъри във Форевър Ливинг България. ",
    },
    {
      name: "Йоанна Й.",
            ...
            <div className="max-w-xl lg:max-w-2xl px-4 lg:px-16">
              ...
              >
                ...
                >
                  ...
                  себе си, своите хобита и близките си!
                </p>
