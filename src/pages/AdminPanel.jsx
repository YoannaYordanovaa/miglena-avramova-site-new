    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-md font-sans"
        >
          <form
            onSubmit={handleLogin}
            className="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl space-y-8"
          >
            ...
            <input
              ...
              className="w-full bg-brand-cream/50 px-6 py-5 rounded-2xl outline-none text-center border-2 border-transparent focus:border-brand-primary/20 transition-all"
  ...
  return (
    <div className="min-h-screen pt-30 md:pt-24 pb-10 px-4 md:px-6 font-sans">
      <div className="max-w-4xl mx-auto space-y-8 text-left">
        <header className="flex justify-between items-center">
          <h1 className="font-display text-4xl tracking-tighter">
            Админ <span className="text-brand-primary italic">Панел</span>
          </h1>
          <button
            onClick={handleLogout}
            className="text-gray-500 hover:text-red-500 flex gap-2 items-center transition-colors font-medium"
          >
          ...
          <form onSubmit={handleSaveNews}>
            <div className="p-6 md:p-10 space-y-6">
                ...
                {formData.imagePreview ? (
                  <div className="relative w-full h-full">
                    ...
                    <button
                      ...
                      className="absolute top-4 right-4 bg-brand-dark p-2 rounded-full text-white"
                    >
                      <X size={14} />
                    </button>
                  </div>
                  ...
                  <label className="absolute inset-0 flex flex-col items-center justify-center cursor-pointer hover:bg-brand-primary/5 transition-colors">
                    <ImageIcon
                      size={32}
                      className="text-brand-primary/20 mb-2"
                    />
              ...
              <div className="space-y-1">
                ...
                />
                <p
                  className={`text-[10px] text-right font-bold uppercase tracking-widest ${formData.title.length >= 80 ? "text-red-500" : "text-gray-400"}`}
                >
            ...
            <div className="bg-white border-y border-brand-primary/5">
              ...
              <div
                className="article-content p-6 md:p-10 overflow-y-auto custom-scrollbar"
            ...
            <div className="p-6 md:p-10 bg-brand-cream/10 space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <input
                  placeholder="Текст на бутона (CTA)"
                  value={formData.buttonText}
                  onChange={(e) =>
                    setFormData({ ...formData, buttonText: e.target.value })
                  }
                  className="px-6 py-4 rounded-xl bg-white border border-gray-100 outline-none focus:border-brand-primary transition-all"
                />
                <input
        ...
        <div className="space-y-4">
          <h3 className="font-display text-2xl px-2 text-brand-dark">
            Архив на статиите
          </h3>
          <div className="grid gap-3">
            {news.map((n) => (
              <div
                key={n.id}
                className="bg-white p-4 rounded-3xl border border-white flex items-center justify-between shadow-sm hover:shadow-md transition-shadow"
              >
      ...
      <style
        ...
        .ProseMirror h2 { font-family: "Cormorant Infant", serif; font-size: 2rem; color: #003f00; margin-top: 1.5rem; text-align: left; } 
