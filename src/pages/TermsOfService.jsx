  ...
  const sections = [
    {
      ...
      content:
        "Този уебсайт е собственост на Миглена Аврамова, независим собственик на бизнес (FBO) към Forever Living Products. Информацията тук е с цел представяне на бизнес възможности и уелнес продукти.",
    },
    {
      icon: <Users size={24} />,
      title: "2. Ползване на сайта",
      content:
        "С достъпа си до този сайт, Вие се съгласявате да го използвате само за законни цели. Забранено е копирането на текстово или визуално съдържание без изричното съгласие на автора.",
    },
    {
      icon: <ShoppingBag size={24} />,
      title: "3. Продукти и Поръчки",
      content:
        "Всички поръчки на продукти се осъществяват през официалната платформа на Forever Living. Ние не съхраняваме плащания и не носим отговорност за логистиката, извършвана от компанията-майка.",
    },
    {
      icon: <ShieldAlert size={24} />,
      title: "4. Отказ от отговорност",
      content:
        "Продуктите и съветите в този сайт не са предназначени за диагностика, лечение или предотвратяване на заболявания. Консултирайте се с лекар преди започване на всякакви нови хранителни режими.",
    },
    {
      icon: <Scale size={24} />,
      title: "5. Промени в условията",
      content:
        "Запазваме си правото да актуализираме тези Общи условия по всяко време. Ваше задължение е периодично да проверявате тази страница за промени.",
    },
  ];
