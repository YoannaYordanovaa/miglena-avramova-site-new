  ...
  try {
    ...
    if (category === "cosmetics") {
      return data.filter((p) =>
        ["Грижа за лицето", "Грижа за тялото", "Лична хигиена"].includes(
          p.category,
        ),
      );
    }
...
export const getOrderUrl = async (productId) => {
  try {
    ...
    const params =
      "?fboId=359100008314&purchaseFlowType=PERSONAL&languageCode=bg-BG&memberTitleId=8&storeId=74&countryCode=bgr&isBots=true&discountConfigType=11&uniqueExtRefID=4729ffc1-e225-4e04-a56e-f54ecf9e1dac&shortenUrl=thealoeveraco.shop/CZNu1yA4&referralUuid=b77a9075-fbc8-4d85-a029-37ea2d45b79b";
